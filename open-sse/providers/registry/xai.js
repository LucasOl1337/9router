export default {
  ...
  // Image only: reuse grok-cli OAuth (api:access) when no dedicated xai connection exists.
  imageConfig: { baseUrl: "https://api.x.ai/v1/images/generations", bodyFields: ["model","prompt","n","response_format","aspect_ratio","resolution","quality"], credentialFallback: "grok-cli" },
